        ...
        if input_type in file_type_dict.keys():
            ...
            for strat in strategies:
                for i in range(1, num_tests):
                    ...
                    output, error, exitcode = self.run_target(f"binaries/{bin_name}", mutated_payload)
                    if "Error:" in output or error != "" and exitcode != 0:
            ...
            for i in range (1, num_tests):
                ...
                output, error, exitcode = self.run_target(f"binaries/{bin_name}", payload)
                if "Error:" in output or error != "" and exitcode != 0:
                    # We do this to get the specifics of the error output via GDB
                    summary = f"Test {i} for {bin_name}:\n{error}\nExit code: {exitcode}\nFound with these parameters:\n{mutation_type}\n"
